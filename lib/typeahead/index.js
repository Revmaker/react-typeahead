...
var Typeahead = React.createClass({
  ...
  _renderIncrementalSearchResults: function () {
    ...
    return React.createElement(
      'div',
      { className: this.props.customClasses.listWrapper, style: style },
      ...
      React.createElement(
        'div',
        { className: this.props.customClasses.footer },
        React.createElement(
          'div',
          null,
          React.createElement('i', { className: 'fa fa-long-arrow-up' }),
          React.createElement('i', { className: 'fa fa-long-arrow-down' }),
          'to navigate'
        ),
        React.createElement(
          'div',
